...
export default function InputDataPage() {
  ...
  return (
    <div className="min-h-screen bg-gray p-6 font-poppins">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6 space-y-6">
        ...
        {selectedAlgo === "rr" && (
          <div className="flex flex-col text-purple sm:flex-row gap-4 items-center">
            <label className="text-sm font-medium text-purple font-poppins">
              Time Quantum:
            </label>
            <input
              type="number"
        ...
        <div>
          {processes.length !== 0 ? (
            <h2 className="text-lg font-semibold text-purple font-poppins ">
              Processes:
            </h2>
          ) : (
            <></>
        ...
        <button
          className="bg-red text-white px-4 py-2 cursor-pointer rounded hover:bg-red-600"
